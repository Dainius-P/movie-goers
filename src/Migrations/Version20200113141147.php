 ...
 */
final class Version20200113141147 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, security_question VARCHAR(255) NOT NULL, security_answer VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, birthday DATE DEFAULT NULL, watch_list_size INT NOT NULL, description TEXT DEFAULT NULL, movies_seen_count INT NOT NULL, coment_count INT NOT NULL, rating_count INT NOT NULL, PRIMARY KEY(id))');
